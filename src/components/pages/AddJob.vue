    ...
    <template v-else>
      ...
      >
        <div class="bg-blue-100 text-sm text-blue-600 px-6 py-6 rounded">
          ...
          job listing, you must provide email address resembling the company
          name you have specified. Once you have submitted the listing, a
          confirmation email will be sent to the address you provided. Your
          listing will be published after clicking the verification link in the
          email you received.
        </div>
        ...
        <div class="my-6 w-full">
          ...
          <p class="text-sm mt-3 mb-10 text-gray-600">
            ...
            <span
              class="border border-red-200 rounded bg-red-100 text-red-600 px-1"
              >.net</span
            >. Choosing the right and effective tags will increase the chances
            of your listing to appear among the 'Similar Listings' section on
